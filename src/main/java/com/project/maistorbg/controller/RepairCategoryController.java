...
public class RepairCategoryController {
    ...
    public ResponseEntity<RepairCategoryInfoDTO> addCategory(@Valid @RequestBody AddRepairCategoryDTO dto) {
    ...
    public ResponseEntity<RepairCategoryInfoDTO> editCategory(@PathVariable int repairCategoryId, @Valid @RequestBody EditRepairCategoryDTO dto) {
        RepairCategory repairCategory = mapper.map(dto, RepairCategory.class);
